...
public partial class bookseat : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            bookedseat = new int[28];
            tempbookseat = new int[28];
            tempbookseat[0] = 0;
            tempbookseat[1] = 0;
            tempbookseat[2] = 0;
            tempbookseat[3] = 0;
    ...
    {
        String mycon = "Data Source=DESKTOP-773C6E4\\SQLEXPRESS; Initial Catalog=ARS; Integrated Security=True";
    ...
    protected void Button29_Click(object sender, EventArgs e)
    {
        ...
        for (i = 0; i < 16; i++)
        {
            ...
            {
                String mycon = "Data Source=DESKTOP-773C6E4\\SQLEXPRESS; Initial Catalog=ARS; Integrated Security=True";
                String updatedata = "Update bookseat set status='B' where seatno=" + (i + 1);
                SqlConnection con = new SqlConnection(mycon);
                con.Open();
                SqlCommand cmd = new SqlCommand();
